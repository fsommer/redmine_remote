        ...
        .subcommand(SubCommand::with_name("issues")
                    ...
                    .subcommand(SubCommand::with_name("create")
                                ...
                                .arg(Arg::with_name("version_id")
                                     ...
                                     .takes_value(true)
                                     .help("Set version id."))
                                .arg(Arg::with_name("assigned_to_id")
                                     .long("set-assigned-to-id")
                                     .takes_value(true)
                                     .help("Set assignet-to id."))
                                .arg(Arg::with_name("parent_issue_id")
                                     .long("set-parent-issue-id")
                                     .takes_value(true)
                                     .help("Set parent-issue id."))
                                .arg(Arg::with_name("watcher_user_ids")
                                     .long("set-watcher-user-ids")
                                     .takes_value(true)
                                     .help("Set watcher-user ids."))
                                .arg(Arg::with_name("is_private")
                                     .long("set-is-private")
                                     .takes_value(true)
                                     .help("Set private flag."))
                                .arg(Arg::with_name("estimated_hours")
                                     .long("set-estimated-hours")
                                     .takes_value(true)
                                     .help("Set estimated hours."))
                                .arg(Arg::with_name("batch_file")
                                     .long("batch-file")
                                     .takes_value(true)
                                     .help("Create multiple issues from csv file"))))
